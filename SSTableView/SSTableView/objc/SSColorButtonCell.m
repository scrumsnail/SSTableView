...
@interface SSColorButtonCell()

@property (nonatomic,strong) SSCommonTableRow *rowData;

@end

@implementation SSColorButtonCell

- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    if (self) {
        self.backgroundColor = [UIColor clearColor];
        _button = [[SSColorButton alloc] initWithFrame:CGRectZero];
...
@implementation SSColorButton : UIButton
